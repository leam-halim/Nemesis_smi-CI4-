...
class CreateInitialTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'feature_index' => ['type' => 'INT', 'constraint' => 11],
        ]);
        ...
        $this->forge->addField([
            ...
            'selection_date' => ['type' => 'VARCHAR', 'constraint' => 50, 'null' => true],
            ...
            'is_umkm' => ['type' => 'TINYINT', 'constraint' => 1, 'default' => 0],
            'within_country' => ['type' => 'TINYINT', 'constraint' => 1, 'default' => 0],
            'volume' => ['type' => 'TEXT', 'null' => true],
            'work_description' => ['type' => 'TEXT', 'null' => true],
            'specification' => ['type' => 'TEXT', 'null' => true],
            'inserted_order' => ['type' => 'INT', 'constraint' => 11, 'default' => 0],
        ]);
        $this->forge->addKey('id', true);
        ...
        $this->forge->addField([
            ...
            'total_budget' => ['type' => 'BIGINT', 'default' => 0],
            ...
            'central_budget' => ['type' => 'BIGINT', 'default' => 0],
            'provincial_budget' => ['type' => 'BIGINT', 'default' => 0],
            'local_budget' => ['type' => 'BIGINT', 'default' => 0],
            'other_budget' => ['type' => 'BIGINT', 'default' => 0],
